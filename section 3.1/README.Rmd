...
## Data
The prepared SARS-CoV-2 concentration data is found in the data folder. The code to prepare this data is found in 'create_work_d.R' and the raw data is also found in the data folder. 
