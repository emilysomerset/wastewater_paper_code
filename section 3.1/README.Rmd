...
This is the code to replicate the results in Section 3.1 of the manuscript. You will need the following libraries. The R version used for this analysis and the package versions are listed below. 
...
## Data
The prepared SARS-CoV-2 concentration data is found in the 'data' folder and is titled 'work_d.RData'. The code to prepare this working data set is 'create_work_d.R'. It is provided, along with the raw datasets, in the data folder. 
