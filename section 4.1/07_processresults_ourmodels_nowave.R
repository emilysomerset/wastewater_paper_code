...
for (i in 1:103){
  load(paste0("~/Wastewater/toEnglish/xiaotian_phac/nowcast_nowave/model",i,'.RData'))
  ...
  write.csv(df_full, file = paste0('~/Wastewater/toEnglish/xiaotian_phac/nowcast_nowave/results_model',i,'.csv'))
  write.csv(tmp, file = paste0('~/Wastewater/toEnglish/xiaotian_phac/nowcast_nowave/CANresults_model',i,'.csv'))
}
